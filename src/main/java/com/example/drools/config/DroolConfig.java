...
public class DroolConfig {
	...
	private KieFileSystem getKieFileSystem() throws IOException {
		...
		/*kieFileSystem.write(ResourceFactory.newClassPathResource("animalType.gdst"));
		String decisionTableXml = new String ( 
				  Files.readAllBytes( 
				    Paths.get("../resources/animalType.gdst") ) );
	...
	*/	
		kieFileSystem.write(ResourceFactory.newClassPathResource("animal.xlsx"));
